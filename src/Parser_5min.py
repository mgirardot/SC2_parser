...
class Parser:
    ...
    def process(self):
        ...
        ##
        # Cut games to 5 mins  ##[ERROR] ## keep games longer than 5 min
        ##
        #self.p1 = self.p1.loc[(self.p1.frames * 11.278 /1000) <= 300]
        #self.p2 = self.p2.loc[(self.p2.frames * 11.278 / 1000) <= 300]
        self.result_DF['game_length'] = self.p1.frames[-1:] * 11.278 / 1000
        ##
        # Units
        ##
        ...
        self.result_DF['p1_timing_1st_scooting'] = timing_1st_scooting(self.p1,self.p2) * 11.278/1000
        self.result_DF['p2_timing_1st_scooting'] = timing_1st_scooting(self.p2,self.p1) * 11.278/1000
        ...
        self.result_DF['p2_max_distance_from_opponent'] = max_distance_from_opponent(self.p2, self.p1)
        ...
        if (len(players)==2):
            ...
            try:
                if max(data.frames[-1:] * 11.278/1000 >= 300):
                    ...
                    df.result_DF['_p1_win_game'] = np.sum(p2['action'].str.find('Leave game') == 0)
